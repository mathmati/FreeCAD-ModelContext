...
constraints* as a legible graph. This fills that gap: one small, adoptable format, complementary to (not
competing with) the servers and agents that already exist.
